...
namespace DocCode.DataAccess
{
    ...
    public class NorthwindDtoRepository
    {
        public NorthwindDtoRepository()
        {
            ...
            _contextProvider = new MyEFContextProvider<Northwind.Models.NorthwindContext>();
            // TODO: RESTORE
        ...
        private readonly MyEFContextProvider<Northwind.Models.NorthwindContext> _contextProvider;
